...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="${mgr}/images/ ico/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="${mgr}/images/ ico/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="${mgr}/images/ ico/apple-touch-icon-72-precomposed.png">
